...
class AddLogPanel(wx.Panel):
    ...
    def GetBox(self, flag):
        ...
        if flag == 'M':
            ...
            self.mid = tc1 = wx.TextCtrl(self, -1, size=(80, -1))
            self.cid1 = tc2 = wx.TextCtrl(self, -1, size=(80, -1))
            self.cid2 = tc3 = wx.TextCtrl(self, -1, size=(80, -1))
            hbox = wx.BoxSizer(wx.HORIZONTAL)
            hbox.Add(st1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 0)
...
#            self.mids.Bind(wx.EVT_KILL_FOCUS, self.OnKillFocus)
            ...
            try:
                self.buyer.SetValue(SymList.blist[0])
            except:
                pass
            hbox = wx.BoxSizer(wx.HORIZONTAL)
            hbox.Add(st1, 0, wx.LEFT, 0)
            hbox.Add((5, -1))
            hbox.Add(tc1, 1, wx.EXPAND|wx.LEFT|wx.RIGHT, 0)
            box.Add((-1, 10))
            box.Add(hbox, 0, wx.EXPAND|wx.LEFT|wx.RIGHT, 10)
            hbox = wx.BoxSizer(wx.HORIZONTAL)
            hbox.Add(st2, 0, wx.LEFT, 0)
            hbox.Add((5, -1))
            hbox.Add(tc2, 1, wx.EXPAND|wx.LEFT|wx.RIGHT, 0)
            box.Add(hbox, 0, wx.EXPAND|wx.ALL, self.extra)
        elif flag == 'B':
            st1 = wx.StaticText(self, label=u'鼠')
            st2 = wx.StaticText(self, label=u'出生于笼')
            self.mid = tc1 = wx.TextCtrl(self, -1, size=(80, -1))
            self.cid = tc2 = wx.TextCtrl(self, -1, size=(80, -1))
            hbox = wx.BoxSizer(wx.HORIZONTAL)
            hbox.Add(st1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 0)
            hbox.Add(tc1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
            hbox.Add(st2, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
            ...
            st1 = wx.StaticText(self, label=u'鼠')
            st2 = wx.StaticText(self, label=u'死亡')
            self.mid = tc1 = wx.TextCtrl(self, -1, size=(80, -1))
            hbox = wx.BoxSizer(wx.HORIZONTAL)
            hbox.Add(st1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 0)
            hbox.Add(tc1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
